    ...
    try {
      switch (currentStep) {
        case 1:
          ...
          await Axios.post("http://localhost:3000/auth/password_recovery", { usernameOrEmail });
        ...
        case 2:
          ...
          const verificationResponse = await Axios.post("http://localhost:3000/auth/validate_verification_code", {
            usernameOrEmail,
            verificationCode,
          });
        ...
        case 3:
          ...
          const response = await Axios.post("http://localhost:3000/auth/verify_and_reset_password", {
            usernameOrEmail,
            verificationCode,
            newPassword,
            confirmPassword,
